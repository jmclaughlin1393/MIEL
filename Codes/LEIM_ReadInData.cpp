...
int ReadInData(std::vector< std::vector<double> >* wavelength_vis, std::vector< std::vector<double> >* wavelength_ir,
  ...
  if (options.Contains("H") && options.Contains("S")){
    ...
    baseline_vis.open("../data/csv_files/REDO_Hamamatsu-VUV4_VISbaseline_200min50kHz_200uA_11_Dec_2020-raw.csv");
    spectrum_vis.open("../data/DarkNoisePaper/newHamamatsuVUV4_VISspectrum_12000s-2021_02_02-16_23_21.csv");
    baseline_ir.open("../data/csv_files/REDO_Hamamatsu-VUV4_IRbaseline_200min50kHz_200uA-2020_Dec_14-raw.csv");
    spectrum_ir.open("../data/DarkNoisePaper/newHamamatsuVUV4_IRspectrum_12000s-2021_02_30-14_33_30.csv");
    ...
    //baseline_vis.open("../data/csv_files/REDO_Hamamatsu-VUV4_VISbaseline_20min50kHz_2mA_11_Dec_2020-raw.csv");
    baseline_vis.open("../data/DarkNoisePaper/newHamamatsuVUV4_VISbackground_17143s-2021_02_04-11_34_45.csv");
    spectrum_vis.open("../data/DarkNoisePaper/newHamamatsuVUV4_VISspectrum_17143s-2021_02_03-08_35_45.csv");
    //baseline_ir.open("../data/csv_files/REDO_Hamamatsu-VUV4_IRbaseline_20min50kHz_2mA_14_Dec_2020-raw.csv");
    baseline_ir.open("../data/DarkNoisePaper/newHamamatsuVUV4_IRbackground_17143s-2021_02_01-19_03_09.csv");
    spectrum_ir.open("../data/DarkNoisePaper/newHamamatsuVUV4_IRspectrum_17143s-2021_01_30-17_59_54.csv");
    ...
    baseline_vis.open("../data/csv_files/REDO_Hamamatsu-VUV4_VISbaseline_9h50kHz_74uA_11_Dec_2020-raw.csv");
    spectrum_vis.open("../data/DarkNoisePaper/newHamamatsuVUV4_VISspectrum_30000s-2021_02_02-19_49_43.csv");
    baseline_ir.open("../data/csv_files/REDO_Hamamatsu-VUV4_IRbaseline_9h50kHz_74uA-2020_Dec_14-raw.csv");
    spectrum_ir.open("../data/DarkNoisePaper/newHamamatsuVUV4_IRspectrum_30000s-2021_01_31-09_55_44.csv");
    ...
    baseline_vis.open("../data/csv_files/REDO_FBK-VUVHD3_VISbaseline_200min50kHz_200uA_09_Dec_2020-raw.csv");
    spectrum_vis.open("../data/DarkNoisePaper/newFBKVUV-HD3_VISspectrum_12000s-2021_02_04-17_40_30.csv");
    baseline_ir.open("../data/csv_files/REDO_FBK-VUVHD3_IRbaseline_200min50kHz_200uA_07_Dec_2020-raw.csv");
    spectrum_ir.open("../data/DarkNoisePaper/newFBKVUV-HD3_IRspectrum_12000s-2021_01_27-17_51_59.csv");
    ...
    //baseline_vis.open("../data/csv_files/REDO_FBK-VUVHD3_VISbaseline_200min50kHz_200uA_09_Dec_2020-raw.csv");
    baseline_vis.open("../data/DarkNoisePaper/newFBKVUV-HD3_VISbackground_17143s-2021_02_05-14_13_26.csv");
    spectrum_vis.open("../data/DarkNoisePaper/newFBKVUV-HD3_VISspectrum_17143s-2021_02_05-07_37_57.csv");
    //baseline_ir.open("../data/csv_files/REDO_FBK-VUVHD3_IRbaseline_200min50kHz_200uA_07_Dec_2020-raw.csv");
    baseline_ir.open("../data/DarkNoisePaper/newFBKVUV-HD3_IRbackground_17143s-2021_01_28-20_22_52.csv");
    spectrum_ir.open("../data/DarkNoisePaper/newFBKVUV-HD3_IRspectrum_17143s-2021_01_28-12_01_00.csv");
    ...
    baseline_vis.open("../data/csv_files/REDO_FBK-VUVHD3_VISbaseline_9h50kHz_74uA_09_Dec_2020-raw.csv");
    spectrum_vis.open("../data/DarkNoisePaper/newFBKVUV-HD3_VISspectrum_30000s-2021_02_04-22_05_28.csv");
    baseline_ir.open("../data/csv_files/REDO_FBK-VUVHD3_IRbaseline_9h50kHz_74uA_07_Dec_2020-raw.csv");
    spectrum_ir.open("../data/DarkNoisePaper/newFBKVUV-HD3_IRspectrum_30000s-2021_01_27-21_38_57.csv");
